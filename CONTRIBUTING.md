...
Welcome to the contributor guide of OctoFlow.
...
If you experience bugs or general issues with OctoFlow, please have a look
...
You can help improve the documentation of OctoFlow by making them more readable
...
3. Clone this copy to your local disk:
   ...
   ```console
   git clone git@github.com:YourLogin/octoflow.git
   cd octoflow
   ```
