...
from octoflow.tracking_fs.experiment import Experiment, get_experiment_id
from octoflow.tracking_fs.run import EMPTY_DICT, FilterExpression, Run, get_run_id
...
class TrackingStore:
    ...
    def bind(
        ...
        elif not isinstance(obj, StoredModel):
            return obj
